    ...
    <section className="flex-1 flex flex-col justify-between p-4  bg-white dark:bg-black rounded-t-3xl">
      <div className='space-y-6 font-medium mt-10'>
            <div className="space-y-1">
              ...
              <p className="flex items-center gap-2 font-normal tracking-wide text-[13px] text-grey-150 dark:text-dark-grey-150"><span>Sent to +91 {number}</span> <SquarePen className="size-4 text-main dark:text-dark-main" onClick={()=>setShowVerificationPage(false)}/></p>
            </div>
            <InputOTP disabled={otpValue.length === 6} value={otpValue} onChange={value =>handleOtpChange(value)} maxLength={6} autoFocus inputMode="numeric" >
