...
const MovingText = ({isReverse, texts}:{isReverse?:boolean, texts:string[]}) => {
  ...
  return (
    <div className={`flex tracking-wide font-light  ${isReverse && '*:direction-reverse'} relative z-0 text-sm  py-2 sm:py-4 *:px-3 lg:*:py-6  *:*:bg-grey-50 dark:*:*:bg-dark-grey-50 *:*:rounded-lg *:*:p-3  whitespace-nowrap overflow-hidden`}>
